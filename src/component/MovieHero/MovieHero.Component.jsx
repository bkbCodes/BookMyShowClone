    ...
    <div>
      ...
      <div className="flex flex-col gap-3 lg:hidden">
        <div className="flex flex-col-reverse gap-3 px-4 my-3">
          <div className=" text-black flex-col gap-2 md:px-4">
            <h4>4k Rating</h4>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 md:px-4 md:w-screen text-xl px-4">
          <button
            onClick={rentMovie}
      ...
      <div className="relative hidden w-full lg:block"
        ...
        <div className="absolute z-10 w-full h-full"
          style={{ backgroundImage: "linear-gradient(90deg, rgb(34,34,34) 24.95%, rgb(34,34,34) 38.3%, rgba(34,34,34,0.04) 97.4%, rgb(34,34,34) 100%" }}
        />

        <div className="absolute z-30 left-24 top-10 flex items-center gap-10">
          <div className="w-64 h96">
            <img src={`https://image.tmdb.org/t/p/original${movie.poster_path}`}
              alt="Movie Poster"
